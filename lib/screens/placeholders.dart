...
class CategoryScreen extends StatelessWidget { final dynamic category; const CategoryScreen({super.key, this.category}); @override Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text("الأقسام")), body: const Center(child: Text("قيد التطوير"))); }
